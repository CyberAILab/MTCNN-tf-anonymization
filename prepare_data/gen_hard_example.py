...
def t_net(prefix, epoch,
    ...
    basedir = './WIDER_train/images/'    
    #anno_file
    filename = './wider_face_train_bbx_gt.txt'
    #read annatation(type:dict)
    wider_data = read_annotation(basedir,filename)
    basedir = '/data/home/guo/dataset/mask/'
    filename = './face_mask_gt.txt'
    mask_data = read_annotation(basedir,filename)
    for key, value in mask_data.iteritems():
        value.extend(wider_data[key])
    ...
    test_data = TestLoader(mask_data['images'])
    #list
    ...
    save_hard_example(image_size, mask_data, save_path)
...
if __name__ == '__main__':
    ...
    #base_dir = '/data/home/guo/dataset'
